"""4-2 defense scenario — wide y-spread zone, Team A circulates ball in backcourt."""

from __future__ import annotations

from ..physics import arc_path, drift_path
from . import ATTACK_A_BASE, DEFENSE_42_BASE, ScenarioBase, build_frames, defense_paths

_DURATION_S = 10.0


class Defense42Scenario(ScenarioBase):
    name = "defense_42"
    ...
    def generate(self, start_frame: int) -> list[MatchFrame]:  # noqa: F821
        ...
        t1 = round(3.0 * fps)
        arc1 = arc_path(cb_path[t1], rb_path[t1], 10, rng)
        ...
        b_paths = defense_paths(DEFENSE_42_BASE, n, rng, amp=0.24)
        player_paths = {
            1: lw_path, 2: rw_path, 3: lb_path, 4: cb_path, 5: rb_path, 6: pv_path,
            7: [(None, None)] * n, **b_paths, 14: [(None, None)] * n,
        }
        action_ranges = [(0, t1, 4, "hold"), (t1, t1+1, 4, "pass"), (t1+10, n, 5, "hold")]
